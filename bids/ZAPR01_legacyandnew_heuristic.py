#!/usr/bin/env python
"""Heuristic for mapping Legacy Oathes ZAP R01 scans into BIDS"""
import os
...
def infotodict(seqinfo):
    ...
    # Baseline session
            ...
            #info[anat_scout].append(s.series_id) #Removed conversion of localizer to nifti
    ...
    # TMS session
        ...
        #if "IFG_Localizers" in s.dcm_dir_name:
            #info[anat_scout_IFG].append(s.series_id) #Removed conversion of localizer to nifti
        ...
        #if "sgACC_Localizers" in s.dcm_dir_name:
            #info[anat_scout_sgACC].append(s.series_id) #Removed conversion of localizer to nifti
    ...
    # DSI session
        ...
        #if "Localizer" in s.protocol_name:
            #info[anat_scout_DSI].append(s.series_id) #Removed conversion of localizer to nifti
