...
touch /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/OutputMeasures/fMRI_sigchange_MNI_Measures/PreIFG_HarvOxAmygdalaROI_SignalChange_Measures_ZAPR01_N65.csv

echo "Case,Amygdala_TMSsp120_sigchange_mean,Amygdala_TMSsp120_sigchange_sd" >> /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/OutputMeasures/fMRI_sigchange_MNI_Measures/PreIFG_HarvOxAmygdalaROI_SignalChange_Measures_ZAPR01_N65.csv 
...
TMSmean=$(fslstats /data/jux/oathes_group/studies/TNI_ZAPR01/MRI/processed/funct/xcp06/sp120/output/pre/ZAPR01_${sub}_sp120_PreIFG/norm/ZAPR01_${sub}_sp120_PreIFG_sigchange_contrast1_TMSonStd.nii.gz -k /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/Amygdala_masks/HarvardOxford-sub-maxprob-thr25-2mm-LHamygdala.nii.gz -M)
TMSsd=$(fslstats /data/jux/oathes_group/studies/TNI_ZAPR01/MRI/processed/funct/xcp06/sp120/output/pre/ZAPR01_${sub}_sp120_PreIFG/norm/ZAPR01_${sub}_sp120_PreIFG_sigchange_contrast1_TMSonStd.nii.gz -k /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/Amygdala_masks/HarvardOxford-sub-maxprob-thr25-2mm-LHamygdala.nii.gz -S)

echo "$SUBJ,$TMSmean,$TMSsd" >> /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/OutputMeasures/fMRI_sigchange_MNI_Measures/PreIFG_HarvOxAmygdalaROI_SignalChange_Measures_ZAPR01_N65.csv


else

echo "$SUBJ,NA,NA" >> /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/OutputMeasures/fMRI_sigchange_MNI_Measures/PreIFG_HarvOxAmygdalaROI_SignalChange_Measures_ZAPR01_N65.csv
