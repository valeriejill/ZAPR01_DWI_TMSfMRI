...
#Segment subject FOD images in template space into fixels, generate FD.mif
#https://mrtrix.readthedocs.io/en/latest/fixel_based_analysis/st_fibre_density_cross-section.html , Step 15
...
/share/apps/singularity/2.5.1/bin/singularity exec -B /data:/home/vsydnor/data /data/jag/cnds/applications/mrtrix_ss3t_beta/ss3t_beta.simg fod2fixel -mask /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/FOD_PopulationTemplate/ZAPR01_FOD_Template_Mask.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-WM-FOD-norm-intemplatespace-notreoriented.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-Fixels-TemplateSpace-notreoriented -afd FD.mif
