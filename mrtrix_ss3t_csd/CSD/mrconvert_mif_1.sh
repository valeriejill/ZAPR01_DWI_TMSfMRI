...
##Convert nii and grad table to mif 
...
if [[ $INDX -ge $LENGTH ]]; then
 ...
 SUBJ=${ARRAY[$INDX]}
mkdir /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ
mkdir /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline
mkdir /data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi

/share/apps/singularity/2.5.1/bin/singularity exec -B /data:/home/vsydnor/data /data/jag/cnds/applications/mrtrix_ss3t_beta/ss3t_beta.simg mrconvert -grad /home/vsydnor/data/jux/oathes_group/studies/TNI_ZAPR01/MRI/BIDS/derivatives/qsiprep_0.6.3/qsiprep/$SUBJ/ses-Baseline/dwi/${SUBJ}_ses-Baseline_acq-DTIb1000mb2dir64_space-T1w_desc-preproc_dwi.b /home/vsydnor/data/jux/oathes_group/studies/TNI_ZAPR01/MRI/BIDS/derivatives/qsiprep_0.6.3/qsiprep/$SUBJ/ses-Baseline/dwi/${SUBJ}_ses-Baseline_acq-DTIb1000mb2dir64_space-T1w_desc-preproc_dwi.nii.gz /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-acq-DTIb1000mb2dir64-preproc_dwi.mif
