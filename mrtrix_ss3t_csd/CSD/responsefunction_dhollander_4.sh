...
##Estimate WM, GM, and CSF Response Functions for each subject with dwi2response dhollander 
...
/share/apps/singularity/2.5.1/bin/singularity exec -B /data:/home/vsydnor/data /data/jag/cnds/applications/mrtrix_ss3t_beta/ss3t_beta.simg dwi2response dhollander /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-acq-DTIb1000mb2dir64-preproc_dwi-biascorrect.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/response_functions/${SUBJ}-WM-response.txt /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/response_functions/${SUBJ}-GM-response.txt /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/response_functions/${SUBJ}-CSF-response.txt -voxels /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-responsefunction-voxels.mif
