...
##Perform bias field correction and intensity normalization on FOD outputs
...
if [[ $INDX -ge $LENGTH ]]; then
 ...
 SUBJ=${ARRAY[$INDX]}
/share/apps/singularity/2.5.1/bin/singularity exec -B /data:/home/vsydnor/data /data/jag/cnds/applications/mrtrix_ss3t_beta/ss3t_beta.simg  mtnormalise /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-WM-FOD.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-WM-FOD-norm.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-GM-CSD.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-GM-CSD-norm.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-CSF-CSD.mif /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-CSF-CSD-norm.mif -mask /home/vsydnor/data/jux/cnds/ZAPR01/mrtrix_ss3t_csd/$SUBJ/ses-Baseline/dwi/${SUBJ}-acq-DTIb1000mb2dir64-preproc_dwi-brainmask-dilated.mif
