...
fslmaths ${line}_siteofstim_BLA_point.nii.gz -dilM -kernel sphere 3 -fmean -bin ${line}_siteofstim_BLA_ROI_3mm.nii.gz
...
fslmaths ${line}_siteofstim_sgACC_point.nii.gz -dilM -kernel sphere 3 -fmean -bin ${line}_siteofstim_sgACC_ROI_3mm.nii.gz
